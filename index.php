...
<html lang="en">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        while($data=mysqli_fetch_array($ambilsemuadatastock)){
                                            ...
                                            $stock = $data['stock'];
                                            $nilaipersediaan = $data['persediaan'];
                                            $idb = $data['idbarang'];
                                        ?>
                                        <tr>
                                            <td><?=$i++;?></td>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            ...
            <br>
            <textarea class="form-control" rows="5" id="comment" placeholder="Deskripsi" name="deskripsi"required></textarea>
            <br>
            <br>
        </div>
        <form>
