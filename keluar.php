                                ...
                                <div class="container mt-3">
                                    ...
                                    <div class="modal fade" id="myModal">
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <br>
                                            <textarea class="form-control" rows="5" id="comment" placeholder="Keterangan" name="keterangan"required></textarea>
                                            <br>
                                            <input type="number" name="qty" placeholder="Quantity" class="form-control"require>
                                            <br>
                                            <input type="number" name="hargajual" placeholder="Harga Jual" class="form-control" require>
                                            <br>
                                            </div>
                                            <form>
